//
//  favorite_detail_ViewController.swift
//  taipeifun
//
...
class favorite_detail_ViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "sourceweb_segue"{
            var destain_surceweb = segue.destination as! favorit_sourceweb_ViewController
            destain_surceweb.sourceweb_url = promote_source_url
        }
        if segue.identifier == "sale_web_segue"{
            var destain_saleweb = segue.destination as! favorite_saleweb_ViewController
            destain_saleweb.sale_web_str = websale_str
        }
        if segue.identifier == "detail_segue"{
            var destain = segue.destination as! favorite_schedule_ViewController
            destain.rececive_data = exibition
